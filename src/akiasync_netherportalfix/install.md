...
Go to [GitHub Releases](https://github.com/virgil698/Aki-Async-NetherPortalFix/releases) to download the latest `.jar` file.
...
3. Check if configuration files are generated in `plugins/AkiAsyncNetherPortalFix/` directory
