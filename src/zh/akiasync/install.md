...
::: warning 前置条件
- JDK 21 或更高版本
- 支持 Leaves Mixin 的服务端（Leaves/Luminol/LightingLuminol/Lophine/Mint）
:::
...
前往 [GitHub Releases](https://github.com/virgil698/Aki-Async/releases) 下载最新版本的 `.jar` 文件。
...
3. 检查 `plugins/AkiAsync/` 目录下是否生成了配置文件

## 配置文件

插件首次加载后会在 `plugins/AkiAsync/` 目录下生成配置文件：
